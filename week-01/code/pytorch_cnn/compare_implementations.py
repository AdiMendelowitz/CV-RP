...
history_numpy = train_numpy(
    model=model_numpy, optimizer=optimizer_numpy, loss_fn=loss_fn_numpy, X_train=X_train, y_train=y_train,
    X_test=X_test, y_test=y_test, num_epochs=5, batch_size=64, verbose=True
)
...
history_pytorch = train_pytorch(
    model=model_pytorch, train_loader=train_loader, test_loader=test_loader, num_epochs=5, lr=0.01
)
...
print("{:<20} {:<15.4f} {:<15.4f} {:<10.4f}".format(
    "Train Accuracy", numpy_train_acc, pytorch_train_acc,
    abs(numpy_train_acc - pytorch_train_acc)))

print("{:<20} {:<15.4f} {:<15.4f} {:<10.4f}".format(
    "Test Accuracy", numpy_test_acc, pytorch_test_acc,
...
print("{:<20} {:<15.4f} {:<15.4f} {:<10.4f}".format(
    "Train Loss", numpy_train_loss, pytorch_train_loss,
    abs(numpy_train_loss - pytorch_train_loss)))

print("{:<20} {:<15.4f} {:<15.4f} {:<10.4f}".format(
    "Test Loss", numpy_test_loss, pytorch_test_loss,
