...
def train_vit_tiny(
    ...
    weight_decay=0.05,
    warmup_epochs=10,
    save_dir: str = "./checkpoints/vit_tiny_cifar10",
    early_stopping_patience=10,
) -> Tuple[dict, VisionTransformer]:
    """
    ...
    print("  Patch size: 4×4")
    print("  Number of patches: 64")
    print("  Embedding dim: 192")
    print("  Depth: 12")
    print("  Attention heads: 3")
    ...
    print("LR schedule: Linear warmup + Cosine decay")
