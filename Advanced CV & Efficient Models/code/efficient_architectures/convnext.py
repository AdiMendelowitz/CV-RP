...
inverted bottleneck MLP, LayerNorm, GELU, fewer activation/norm layers, while remaining a standard convolutional
network.
"""
...
if __name__ == "__main__":
    ...
    assert logits.shape == (
        2,
        1000,
    ), f"Unexpected output shape {logits.shape}, expected (2, 1000)"
